...
public class testMicroservice extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "test-microservice43", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "test", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/cae-test/microservice-test-microservice43/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response testMethod() {
    ...
    if(testResponse_condition) {
      ...
      testResult.put("echoResponse", echoPayload);
